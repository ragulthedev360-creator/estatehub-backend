...
//          bedrooms, bathrooms, area_sqft, city, locality, address, slug)
...
//     if (files.length > 0) {
//       const imageInserts = files.map((file, idx) =>
//         client.query(
...
// export async function updateProperty(propertyId, ownerId, data) {
//   const existing = await assertOwnership(propertyId, ownerId);
...
//   await pool.query(
//     `UPDATE properties SET ${fields.join(', ')} WHERE id = $${i}`,
//     values
//   );
...
//   await assertOwnership(propertyId, ownerId);
//   await pool.query('DELETE FROM properties WHERE id = $1', [propertyId]);
// }

// async function assertOwnership(propertyId, userId) {
//   const result = await pool.query(
...
//     throw new PropertyError('You do not have permission to modify this listing', 403);
//   }
//   return property;
// }
